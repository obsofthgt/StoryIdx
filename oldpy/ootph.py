...
CONFIG = {
    ...
    'ARW_DISPLAY': 1   # 1 to show arrows, 0 to hide them
}
...
<head>
    ...
    <style>
        ...
        .page-number {
            ...
            font-size: 0.625em; /* Increased by 25% from 0.5em */
        ...
        .arrow-container.left:hover {
            opacity: ARW_HOVER_OPACITY;
            pointer-events: ARW_HOVER_EVENTS;
        }
...
def build_final_html(pages):
    ...
    arw_display = "block" if CONFIG['ARW_DISPLAY'] else "none"
    arw_opacity = "0" if CONFIG['ARW_DISPLAY'] else "0"
    arw_events = "auto" if CONFIG['ARW_DISPLAY'] else "none"
    arw_hover_opacity = "1" if CONFIG['ARW_DISPLAY'] else "0"
    arw_hover_events = "auto" if CONFIG['ARW_DISPLAY'] else "none"
    
    html_template = HTML_TEMPLATE\
        .replace('ARW_DISPLAY', arw_display)\
        .replace('ARW_OPACITY', arw_opacity)\
        .replace('ARW_EVENTS', arw_events)\
        .replace('ARW_HOVER_OPACITY', arw_hover_opacity)\
        .replace('ARW_HOVER_EVENTS', arw_hover_events)
